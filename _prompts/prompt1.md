...
Você vai criar o banco de dados para um sistema de gestão para nutricionistas. Você tem acesso ao Neon via MCP e o projeto já foi criado com o nome de "NatuNutri". Então pode e deve criar toda a estrutura diretamente via MCP, sem necessidade de copiar SQL manualmente.
...
Após criar todas as tabelas e relacionamentos, ative o Row Level Security (RLS) em todas as tabelas para garantir que cada nutricionista acesse apenas os seus próprios dados. Configure as políticas necessárias para isso.
